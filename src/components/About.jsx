            ...
            <div className="relative">
              ...
              <div className="relative bg-white rounded-2xl shadow-2xl p-4 sm:p-6 lg:p-8 border border-gray-100">
                ...
                <p className="text-gray-700 leading-relaxed mb-4 sm:mb-6 text-sm sm:text-base">
                  ...
                  creating meaningful connections between talented professionals
                  and forward-thinking organizations. We don't just fill
                  positions; we build careers and transform businesses.
                </p>
                <p className="text-gray-700 leading-relaxed text-sm sm:text-base">
                  Our team of expert advisors works tirelessly to understand
                  your unique needs, ensuring personalized service that delivers
                  exceptional results. Whether you're seeking your next career
                  opportunity or looking to build your dream team, Maplorix is
