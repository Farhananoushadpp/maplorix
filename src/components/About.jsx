...
const About = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description:
        'Connecting the right talent with opportunities across regions.',
      color: 'text-secondary',
    },
  ]

  const stats = [
    { number: '15000+', label: 'Success Stories' },
    ...
    <>
      ...
      >
        ...
        <div className="container relative z-10 px-4">
              ...
              <div className="relative">
                ...
                <div className="relative bg-white rounded-2xl shadow-2xl p-4 sm:p-6 lg:p-8 border border-gray-100">
                  ...
                  <p className="text-gray-700 leading-relaxed mb-4 sm:mb-6 text-sm sm:text-base">
                    Maplorix is a premier recruitment company dedicated to
                    creating meaningful connections between talented
                    professionals and forward-thinking organizations. We don't
                    just fill positions; we build careers and transform
                    businesses.
                  </p>
                  <p className="text-gray-700 leading-relaxed text-sm sm:text-base">
                    Our team of expert advisors works tirelessly to understand
                    your unique needs, ensuring personalized service that
                    delivers exceptional results. Whether you're seeking your
                    next career opportunity or looking to build your dream team,
                    Maplorix is here to guide you every step of the way.
                  </p>
                </div>
              </div>
            </div>
                    ...
                    <div className="bg-white rounded-xl p-4 sm:p-6 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-105 border border-gray-100">
                      <div className="flex items-center mb-3 sm:mb-4">
                        <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-r from-secondary/20 to-accent/20 rounded-full flex items-center justify-center mr-3 sm:mr-4 group-hover:scale-110 transition-transform">
                          <i
                            className={`fas ${feature.icon} ${feature.color} text-sm sm:text-lg`}
                          ></i>
                        </div>
          ...
          {/* Stats Section */}
          <div
            className={`bg-gradient-to-r from-primary to-primary/90 rounded-2xl p-6 sm:p-8 md:p-12 text-white transition-all duration-1600 transform ${
              isVisible
                ? 'translate-y-0 opacity-100'
                : 'translate-y-8 opacity-0'
            }`}
