        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8 mb-6 sm:mb-8 px-2 sm:px-0">
          ...
          <div className="lg:col-span-1 sm:col-span-2 text-center sm:text-left">
            ...
            <div className="flex justify-center sm:justify-start space-x-2 sm:space-x-3">
              <a href="https://www.facebook.com/JobsinDubaiuaeall/" target="_blank" rel="noopener noreferrer" className="w-8 h-8 sm:w-9 sm:h-9 lg:w-10 lg:h-10 bg-white/20 rounded-full flex items-center justify-center hover:bg-secondary hover:text-primary transition-all duration-300 transform hover:scale-110">
                <i className="fab fa-facebook-f text-xs sm:text-sm"></i>
              </a>
              <a href="#" target="_blank" rel="noopener noreferrer" className="w-8 h-8 sm:w-9 sm:h-9 lg:w-10 lg:h-10 bg-white/20 rounded-full flex items-center justify-center hover:bg-secondary hover:text-primary transition-all duration-300 transform hover:scale-110">
                <i className="fab fa-twitter text-xs sm:text-sm"></i>
              </a>
              <a href="https://www.linkedin.com/company/maplorix/" target="_blank" rel="noopener noreferrer" className="w-8 h-8 sm:w-9 sm:h-9 lg:w-10 lg:h-10 bg-white/20 rounded-full flex items-center justify-center hover:bg-secondary hover:text-primary transition-all duration-300 transform hover:scale-110">
                <i className="fab fa-linkedin-in text-xs sm:text-sm"></i>
              </a>
              <a href="https://www.instagram.com/maplorix?igsh=MXR4ajMzb25zbzgyaw==" target="_blank" rel="noopener noreferrer" className="w-8 h-8 sm:w-9 sm:h-9 lg:w-10 lg:h-10 bg-white/20 rounded-full flex items-center justify-center hover:bg-secondary hover:text-primary transition-all duration-300 transform hover:scale-110">
          ...
          <div className="text-center sm:text-left">
            <h4 className="text-base sm:text-lg font-bold mb-2 sm:mb-4">Why Choose Us</h4>
          ...
          {/* Contact Info */}
          <div className="lg:col-span-1 sm:col-span-2 text-center sm:text-left">
            <h4 className="text-base sm:text-lg font-bold mb-2 sm:mb-4">Contact Us</h4>
            <div className="space-y-2 sm:space-y-3">
              ...
              <div className="flex items-center justify-center sm:justify-start text-white/80 text-xs sm:text-sm">
                ...
                <span class="break-all">hr@maplorix.ae</span>
              </div>
              <div className="flex items-start justify-center sm:justify-start text-white/80 text-xs sm:text-sm">
                ...
                <span className="leading-relaxed text-center sm:text-left max-w-xs">
                  A5 Block, Office No:45, Xavier Business Center, Burj Nahar Mall, Al Muteena, Dubai
                </span>
              </div>
            </div>
          </div>
        ...
        <div className="border-t border-white/20 pt-4 sm:pt-6">
          <div className="flex justify-center items-center">
            <div className="text-white/60 text-xs sm:text-sm text-center">
              &copy; 2024 <a href="https://tarah.ae/" target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-secondary transition-colors">Tarah advertising</a>. All rights reserved.
            </div>
          </div>
        </div>
      </div>
