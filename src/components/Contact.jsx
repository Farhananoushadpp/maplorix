      ...
      <div className="container px-4 sm:px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12">
          ...
          <div className="order-2 lg:order-1">
            <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-primary mb-4 sm:mb-6 lg:mb-8">
              Get in Touch
            </h3>
            ...
            <div className="space-y-3 sm:space-y-4 lg:space-y-6">
              {contactInfo.map((info, index) => (
                <div
                  key={index}
                  className="flex items-start space-x-3 sm:space-x-4 p-3 sm:p-4 bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow duration-300"
                >
                  <div className="flex-shrink-0 w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-r from-secondary/20 to-accent/20 rounded-full flex items-center justify-center">
                    <i
                      className={`fas ${info.icon} text-secondary text-sm sm:text-base`}
                    ></i>
                  </div>
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs sm:text-sm lg:text-base text-gray-600 font-medium break-words">
                      {info.text}
                    </p>
