...
const PostsFeed = () => {
  ...
  useEffect(() => {
    ...
    const handleJobPosted = (event) => {
      console.log('📋 PostsFeed: Received jobPosted event:', event.detail)
      // Refetch jobs to get latest data
      fetchPosts()
    }
  ...
  const fetchPosts = async () => {
    try {
      ...
      console.log('📋 PostsFeed: Loaded jobs from backend:', jobs.length)
    } catch (error) {
                ...
                <div className="p-6">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <button
                      ...
                      className="px-6 py-2 bg-accent text-white rounded-lg hover:bg-accent/90 transition-colors flex items-center space-x-2 font-medium"
                    >
