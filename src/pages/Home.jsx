...
const Home = () => {
  ...
  useEffect(() => {
    ...
    fetchJobs()
  }, [fetchJobsForFeed, refetchTrigger])
    ...
    <>
      <SEO
        ...
        structuredData={{
          ...
          description:
            'Premier recruitment agency connecting talented professionals with top employers',
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
                  ...
                  <article className="bg-white rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 hover:shadow-xl transition-shadow">
                    ...
                    <p className="text-sm sm:text-base text-text-light mb-4">
                      ...
                      experience, and career goals. We connect you with
                  ...
                  <article className="bg-white rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 hover:shadow-xl transition-shadow">
                    <div className="mb-4">
                      <img
                        ...
                        onError={(e) => {
                          // Fallback to jpg if webp fails
                          e.target.src = '/resumebuilder.webp'
                        }}
                      />
                    </div>
                    <h3 className="text-lg sm:text-xl font-bold text-primary mb-3">
                    ...
                    <p className="text-sm sm:text-base text-text-light mb-4">
                      Professional resume optimization to highlight your
                      strengths and stand out to employers. Our experts help you
                  ...
                  <article className="bg-white rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 hover:shadow-xl transition-shadow">
                    <div className="mb-4">
                      <img
                        ...
                        onError={(e) => {
                          // Fallback to jpg if webp fails
                          e.target.src = '/interviewpreparation.webp'
                        }}
                      />
                    </div>
                    <h3 className="text-lg sm:text-xl font-bold text-primary mb-3">
                    ...
                    <p className="text-sm sm:text-base text-text-light mb-4">
                      Comprehensive interview coaching including mock
                      interviews, feedback sessions, and confidence-building
                      techniques to ace your interviews.
                    </p>
                    <ul className="space-y-2">
                      <li className="flex items-center text-xs sm:text-sm text-secondary">
                        <i
                  ...
                  <article className="bg-white rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 hover:shadow-xl transition-shadow">
                    <div className="mb-4">
                      <img
                        ...
                        onError={(e) => {
                          // Fallback to jpg if webp fails
                          e.target.src = '/careercunseling.webp'
                        }}
                      />
                    </div>
                    <h3 className="text-lg sm:text-xl font-bold text-primary mb-3">
                    ...
                    <p className="text-sm sm:text-base text-text-light mb-4">
                      Expert guidance on career path planning, skill
                      development, and professional growth strategies to advance
              ...
              <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
                  ...
                  <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 hover:shadow-xl transition-shadow border border-gray-100">
                    ...
                    <p className="text-sm sm:text-base text-text-light mb-4">
                      End-to-end recruitment solutions to find, attract, and
                      hire the best talent for your organization. We handle the
                  ...
                  <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 hover:shadow-xl transition-shadow border border-gray-100">
                    ...
                    <p className="text-sm sm:text-base text-text-light mb-4">
                      ...
                      and contract placements to meet your dynamic business
                      needs.
                    </p>
                    <div className="space-y-2">
                      <div className="flex items-center text-xs sm:text-sm text-secondary">
                  ...
                  <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 hover:shadow-xl transition-shadow border border-gray-100">
                    ...
                    <p className="text-sm sm:text-base text-text-light mb-4">
                      Specialized executive recruitment for senior-level
                      positions and leadership roles with confidentiality and
                      precision.
                    </p>
                    <div className="space-y-2">
                      <div className="flex items-center text-xs sm:text-sm text-secondary">
