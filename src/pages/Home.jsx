...
const Home = () => {
  ...
  const handlePostJobSubmit = async (e) => {
    ...
    try {
      ...
      setPostJobErrors({ submit: error.message || 'Failed to post job. Please try again.' });
    } finally {
  ...
  return (
    <div className="min-h-screen bg-white">
      <main>
        <Hero onUploadResume={() => setShowResumeModal(true)} onPostJob={handlePostJobClick} />
        <About />
                      ...
                      <div className="md:w-3/5 flex flex-col justify-center">
                        ...
                        <div className="flex items-center mb-4 sm:mb-6">
                          <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-r from-secondary/20 to-accent/20 rounded-2xl flex items-center justify-center mr-3 sm:mr-4 group-hover:scale-110 transition-transform">
                            <i className={`fas ${service.icon} text-secondary text-lg sm:text-xl`}></i>
                          </div>
                          <div>
                        ...
                        {/* Service Description */}
                        <p className="text-gray-600 leading-relaxed mb-4 sm:mb-6 text-sm sm:text-base">{service.description}</p>
            ...
            <div className="text-center mt-12">
              <div className="bg-gradient-to-r from-secondary/10 to-accent/10 rounded-2xl p-8 border border-secondary/20">
                ...
                <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
                  Join thousands of professionals who've transformed their careers with our expert guidance and support.
                </p>
                <button 
          ...
          <div className="container relative z-10 px-4">
                      ...
                      <div className="md:w-3/5 flex flex-col justify-center">
                        ...
                        <div className="flex items-center mb-4 sm:mb-6">
                          <div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-r from-accent/20 to-secondary/20 rounded-2xl flex items-center justify-center mr-3 sm:mr-4 group-hover:scale-110 transition-transform">
                            <i className={`fas ${service.icon} text-accent text-lg sm:text-xl`}></i>
                          </div>
                          <div>
                            <h3 className="text-lg sm:text-xl md:text-2xl font-bold text-primary">{service.title}</h3>
                            <div className="flex items-center mt-1">
            ...
            <div className="text-center mt-12">
              <div className="bg-gradient-to-r from-accent/10 to-secondary/10 rounded-2xl p-8 border border-accent/20">
                ...
                <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
                  Partner with us to access top talent and streamline your hiring process with our proven recruitment strategies.
                </p>
                <button 
                ...
                <div className="mb-6 p-4 bg-red-50 border border-red-200 rounded-xl">
                  <div className="flex">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-red-700 mt-1">{postJobErrors.submit}</p>
                    </div>
                  </div>
                </div>
              )}
              ...
              <form onSubmit={handlePostJobSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-accent focus:border-transparent ${
                        postJobErrors.title ? 'border-red-300' : 'border-gray-300'
                      }`}
                      placeholder="e.g. Senior Software Developer"
                    />
                    {postJobErrors.title && (
                      <p className="mt-1 text-sm text-red-600">{postJobErrors.title}</p>
                    )}
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handlePostJobChange}
                      className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-accent focus:border-transparent ${
                        postJobErrors.company ? 'border-red-300' : 'border-gray-300'
                      }`}
                      placeholder="e.g. Tech Corp"
                    />
                    {postJobErrors.company && (
                      <p className="mt-1 text-sm text-red-600">{postJobErrors.company}</p>
                    )}
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handlePostJobChange}
                      className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-accent focus:border-transparent ${
                        postJobErrors.location ? 'border-red-300' : 'border-gray-300'
                      }`}
                      placeholder="e.g. New York, NY"
                    />
                    {postJobErrors.location && (
                      <p className="mt-1 text-sm text-red-600">{postJobErrors.location}</p>
                    )}
                  </div>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={handlePostJobChange}
                      className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-accent focus:border-transparent ${
                        postJobErrors.type ? 'border-red-300' : 'border-gray-300'
                      }`}
                    >
                    ...
                    {postJobErrors.type && (
                      <p className="mt-1 text-sm text-red-600">{postJobErrors.type}</p>
                    )}
                  </div>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={handlePostJobChange}
                      className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-accent focus:border-transparent ${
                        postJobErrors.category ? 'border-red-300' : 'border-gray-300'
                      }`}
                    >
                    ...
                    {postJobErrors.category && (
                      <p className="mt-1 text-sm text-red-600">{postJobErrors.category}</p>
                    )}
                  </div>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={handlePostJobChange}
                      className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-accent focus:border-transparent ${
                        postJobErrors.experience ? 'border-red-300' : 'border-gray-300'
                      }`}
                    >
                    ...
                    {postJobErrors.experience && (
                      <p className="mt-1 text-sm text-red-600">{postJobErrors.experience}</p>
                    )}
                  </div>
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-accent focus:border-transparent resize-vertical ${
                      postJobErrors.description ? 'border-red-300' : 'border-gray-300'
                    }`}
                    placeholder="Describe the role, responsibilities, and what you're looking for..."
                  />
                  {postJobErrors.description && (
                    <p className="mt-1 text-sm text-red-600">{postJobErrors.description}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={3}
                    className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-accent focus:border-transparent resize-vertical ${
                      postJobErrors.requirements ? 'border-red-300' : 'border-gray-300'
                    }`}
                    placeholder="List the required skills, qualifications, and experience..."
                  />
                  {postJobErrors.requirements && (
                    <p className="mt-1 text-sm text-red-600">{postJobErrors.requirements}</p>
                  )}
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handlePostJobChange}
                      className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-accent focus:border-transparent ${
                        postJobErrors['salary.max'] ? 'border-red-300' : 'border-gray-300'
                      }`}
                      placeholder="80000"
                    />
                    {postJobErrors['salary.max'] && (
                      <p className="mt-1 text-sm text-red-600">{postJobErrors['salary.max']}</p>
                    )}
                  </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handlePostJobChange}
                    className={`w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-accent focus:border-transparent ${
                      postJobErrors.applicationDeadline ? 'border-red-300' : 'border-gray-300'
                    }`}
                  />
                  {postJobErrors.applicationDeadline && (
                    <p className="mt-1 text-sm text-red-600">{postJobErrors.applicationDeadline}</p>
                  )}
                </div>
            ...
            <div className="inline-block w-full max-w-4xl my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-lg">
              ...
              <div className="max-h-[80vh] overflow-y-auto">
                <form onSubmit={handleSubmit} className="p-6">
                  ...
                  {/* Resume Upload */}
                  <div className="mb-6">
                    <h3 className="text-lg font-semibold text-primary mb-4">Resume Upload</h3>
